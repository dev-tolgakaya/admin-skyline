...
const EcommerceProductDetail = props => {
 ...
 const selectProperties = createSelector(
  ...
  const { product } = useSelector(selectProperties);
                      ...
                      <Col xl="6">
                        <div className="mt-4 mt-xl-3">
                          ...
                          <Row className="mb-3">
                            <Col md="6">
                              {product.features &&
                                product.features.map((item: any, i: number) => (
                                  <div key={i}>
                          ...
                          <div className="product-color">
                            ...
                            {product.colorOptions &&
                              product.colorOptions.map((option: any, i: number) => (
                        ...
                        <Table className="table mb-0 table-bordered">
                          <tbody>
                            {product.specification &&
                              product.specification.map((specification: any, i: number) => (
                                <tr key={i}>
                                  <th
                                    scope="row"
                                    style={{ width: "400px" }}
