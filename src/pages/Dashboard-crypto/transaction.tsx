...
interface transactionsDataALLType {
  id: number,
  icon: string,
  color: string,
  type: string,
                ...
                <SimpleBar style={{ maxHeight: "330px" }}>
                  <div className="table-responsive">
                    <Table className="table align-middle table-nowrap">
                      <tbody>
                        {
                          (transactionsDataALL || []).map((item: transactionsDataALLType, index: number) => (
                            <tr key={index}>
                              <td style={{ width: "50px" }}>
                  ...
                  <div className="table-responsive">
                    <Table className="table align-middle table-nowrap">
                      <tbody>
                        ...
                        {(transactionsDataBuy || []).map((transaction: transactionsDataALLType, index: number) => (
                          <tr key={index}>
                            <td style={{ width: '50px' }}>
              ...
              <TabPane tabId="3">
                <SimpleBar style={{ maxHeight: "330px" }}>
                  <div className="table-responsive">
                    <Table className="table align-middle table-nowrap">
                      <tbody>
                        {(transactionsDataSell || []).map((transaction: transactionsDataALLType, index: number) => (
                          <tr key={index}>
                            <td style={{ width: "50px" }}>
                              <div className={`font-size-22 text-${transaction.color}`}>
