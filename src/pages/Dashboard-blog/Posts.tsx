...
interface postRecentDataType {
  img: string,
  title: string,
  date: string
}

interface postPopularDataType {
  img: string,
  title: string,
  date: string,
                ...
                <TabContent activeTab={activeTab}>
                  <TabPane className="show" tabId="1">
                    <ul className="list-group list-group-flush">
                      {(postRecentData || []).map((item: postRecentDataType, index: number) => (
                  ...
                  <TabPane className="show" tabId="2">
                    <ul className="list-group list-group-flush">
                      {(postPopularData || []).map((item: postPopularDataType, index: number) => (
                        <li className="list-group-item py-3" key={index}>
                          <div className="d-flex">
                            <div className="me-3">
                              <img
