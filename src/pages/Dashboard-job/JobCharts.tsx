...
const StatisticsApplicationsChart = ({ statisticsApplications, dataColors }: any) => {
    var statisticsApplicationColors = getChartColorsArray(dataColors);

    const series: any = [{
        name: 'Companay',
        type: 'column',
        data: statisticsApplications?.companay || []
    }, {
        name: 'New Jobs',
        type: 'column',
        data: statisticsApplications?.newjobs || []
    }, {
        name: 'Total Jobs',
        type: 'area',
        data: statisticsApplications?.totaljobs || []
    }, {
        name: 'Job View',
        type: 'line',
        data: statisticsApplications?.jobview || []
    }];
    var options: any = {
        chart: {
            height: 350,
